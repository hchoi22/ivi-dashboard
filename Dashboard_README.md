...
This project is a Streamlit dashboard for exploring CDISC-mapped synthetic clinical trial data across T002, T005, and T006. It's part of the clinical data mapping project for internal IVI clinical trials, and it demonstrates EAV-to-relational querying and cross-study analysis.
...
| Medical History | What medical history was reported per study, what share of T005/T006 participants reported suspected typhoid, and when did symptoms start? | MH | `/mh-coverage`, `/mh-questions`, `/mh-onset` |
...
| Subject Trace | What's one participant's full dosing and adverse-event history, linked across T002 and T006? | EX, AE, subject_linkage, DM | `/linkage`, `/subject-profile`, `/subject-demographics`, `/subject-events` |
...
All data referenced and processed by this pipeline and dashboard is fully synthetic, generated to resemble the structure of IVI's Vi-DT clinical study exports (T002, T005, T006) without containing any real participant information. No real subject identifiers, dates, or clinical values are included in this repository or its outputs. Source files themselves are not included in this repository due to data-sharing restrictions; this documentation describes the transformation logic, schema design, and mapping approach rather than providing a runnable end-to-end example.
